...
define () ->
  class MutatorCommands
    ...
    addToScope: (scope) ->
      scope.addFunction('gene',      (name, min, max) => @gene(name, min, max))
      scope.addFunction('g',         (name, min, max) => @gene(name, min, max))
      scope.addFunction('animSpeed', (a) => @setAnimSpeed(a))
      scope.addFunction('mutateDir', (delta) => @mutateDir(delta))
      scope.addFunction('mutate',    (delta) => @mutate(delta))
